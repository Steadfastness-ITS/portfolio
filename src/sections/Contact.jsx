          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            ...
            <div className="bg-white p-8 md:p-12 rounded-[2.5rem] shadow-2xl shadow-slate-200/60 border border-slate-50 animate-contact-right">
              <form className="space-y-6">
                ...
                <button className="w-full py-4 bg-gradient-to-r from-[#6366f1] to-[#a855f7] text-white font-bold rounded-2xl shadow-lg shadow-purple-200 flex items-center justify-center gap-3 hover:-translate-y-1 transition-transform">
                  <svg width="18" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><line x1="22" x2="11" y1="2" y2="13"></line><polygon points="22 2 15 22 11 13 2 9 22 2"></polygon></svg>
                  Send Message
                </button>
              </form>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-16 mb-20">
            ...
            <div className="space-y-6">
              ...
              <div className="flex gap-4">
                {/* Icons match log.mp4 hover logic: purple background on hover */}
                {[
                  ...
                  <div key={i} className="w-10 h-10 rounded-full border border-slate-700 flex items-center justify-center text-slate-400 hover:text-white hover:bg-[#a855f7] hover:border-transparent transition-all cursor-pointer">
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d={social.path}></path></svg>
                  </div>
                ))}
              </div>
