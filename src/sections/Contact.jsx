    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-16 mb-20">
      ...
      <div className="space-y-6">
        ...
        <div className="flex gap-4">
          ...
          {[
            { name: "GitHub", url: "https://github.com/Steadfastness-ITS", path: "M9 19c-5 1.5-5-2.5-7-3m14 6v-3.87a3.37 3.37 0 0 0-.94-2.61c3.14-.35 6.44-1.54 6.44-7A5.44 5.44 0 0 0 20 4.77 5.07 5.07 0 0 0 19.91 1S18.73.65 16 2.48a13.38 13.38 0 0 0-7 0C6.27.65 5.09 1 5.09 1A5.07 5.07 0 0 0 5 4.77a5.44 5.44 0 0 0-1.5 3.78c0 5.42 3.3 6.61 6.44 7A3.37 3.37 0 0 0 9 18.13V22" },
            { name: "LinkedIn", url: "#", path: "M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z M2 9h4v12H2z M4 4a2 2 0 1 1 0 4 2 2 0 0 1 0-4z" },
            ...
            { name: "WhatsApp", url: "https://wa.me/2349150349342", path: "M23 12.5a10.5 10.5 0 1 1-1.1-4.7L23.5 2l-5.8 1.4A10.5 10.5 0 0 1 23 12.5Z M16.03 14.88c-.14-.3-.81-.76-.92-.81-.19-.08-.34-.12-.49.12-.13.23-.53.76-.66.92-.12.16-.24.18-.46.06-.21-.11-.88-.35-1.68-1.11-.62-.55-1.04-1.24-1.16-1.45-.12-.21-.01-.32.09-.43.1-.1.21-.24.32-.37.1-.12.14-.21.21-.35.07-.14.03-.26-.02-.37-.05-.1-.47-1.13-.64-1.55-.17-.4-.34-.35-.47-.36-.12-.01-.26-.01-.4-.01-.14 0-.37.05-.56.26-.19.21-.73.71-.73 1.74 0 1.03.75 2.02.85 2.16.1.14 1.47 2.25 3.56 3.16.5.21.89.34 1.19.44.5.16.96.14 1.31.08.4-.06 1.23-.51 1.41-.99.17-.49.17-.91.12-.99-.05-.09-.19-.14-.4-.25Z" }
          ].map((social, i) => (
            <a 
              key={i} 
              href={social.url}
