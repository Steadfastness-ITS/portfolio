      ...
      <div className="space-y-6">
        ...
        <div className="flex gap-4">
          ...
          {[
            ...
            { name: "WhatsApp", url: "https://wa.me/2349150349342", path: "M21 11.5a8.38 8.38 0 0 1-.9 3.8 8.5 8.5 0 1 1-7.6-11.7 8.38 8.38 0 0 1 3.8.9L21 3.5Z M17 16c-.2-.4-1.2-1-1.4-1.1s-.4-.1-.6.1-1 1.2-1.2 1.4-.4.2-.8 0a5.2 5.2 0 0 1-2-1.2 5.9 5.9 0 0 1-1.4-1.7c-.2-.4 0-.6.2-.8s.4-.4.6-.6.2-.4.3-.6-.1-.4-.2-.6-1-2.4-1.4-2.9-.8-.4-1-.4h-.8a1.6 1.6 0 0 0-1.2.5 4.8 4.8 0 0 0-1.5 3.5 8.7 8.7 0 0 0 1.8 4.7 18.7 18.7 0 0 0 7 6.2 7.7 7.7 0 0 0 2.5.5 4.4 4.4 0 0 0 2.5-.7 2.8 2.8 0 0 0 1.6-2.4V16.5c0-.1 0-.3-.1-.5Z" }
          ].map((social, i) => (
            <a 
              key={i} 
              href={social.url}
